...
public class QuickJSContext {
    ...
    public Object evaluateModule(String script, String moduleName) { return null; }
    public Object evaluateModule(String script) { return null; }

    public byte[] compileModule(String script, String moduleName) { return new byte[0]; }
    public byte[] compileModule(String script) { return new byte[0]; }

    public Object execute(byte[] bytecode, String filename) { return null; }
    public Object execute(byte[] bytecode) { return null; }
    public Object execute(String script, String filename) { return null; }
    public Object execute(String script) { return null; }
    ...
    public JSObject getGlobalObject() { return new JSObject(this); }
    public JSObject createNewJSObject() { return new JSObject(this); }
    public JSArray createNewJSArray() { return new JSArray(); }
    public JSObject createJSObject() { return new JSObject(this); }
    public JSArray createJSArray() { return new JSArray(); }

    public JSFunction createNewJSFunction(JSCallFunction function) { return new JSFunction(); }
    public JSFunction createJSFunction(JSCallFunction function) { return new JSFunction(); }

    public Object parse(String json) { return new JSObject(this); }
